                        ...
                        for (var i = 0; i < arrList.length; i++) {
                            ...
                            if (
                                ...
                                var classString =
                                    arrList[
                                        i
                                    ].firstChild.firstChild.getAttribute(
                                        "class"
                                    );
            ...
            function (e) {
                ...
                if ($(this).hasClass("text-warning")) {
                    ...
                    var $url = $(this).parent()[0].href,
                        ...
                        $listItemDropdown = "",
                        iconName =
                            $(this).parent()[0].firstChild.firstChild.dataset
                                .icon;
                    if (
        ...
        function setLayout(currentLocalStorageLayout) {
            ...
            if (switchToLayout === "dark-layout") {
                ...
                navLinkStyle
                    .find(".ficon")
                    .replaceWith(
                        feather.icons["sun"].toSvg({ class: "ficon" })
                    );
                ...
                navLinkStyle
                    .find(".ficon")
                    .replaceWith(
                        feather.icons["moon"].toSvg({ class: "ficon" })
                    );
